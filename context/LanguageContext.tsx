...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'privacy.commitment.text': 'At True Pipeline, we take your data privacy seriously. This policy describes how we collect, use, and handle your information when you use our website, CRM, and automated growth tools.',
        'privacy.sms.title': 'SMS & Telephony Privacy',
        'privacy.sms.intro': 'True Pipeline is built on multi-channel communication. We have strict rules regarding phone number data:',
        'privacy.sms.consent': 'Consent:',
        'privacy.sms.consent_text': 'By providing your phone number and opting in via our forms, you agree to receive SMS/MMS messages. You can reply STOP at any time to opt out.',
        'privacy.sms.sharing': 'No Sharing:',
        'privacy.sms.sharing_text': 'Mobile information will NOT be shared with third parties or affiliates for marketing or promotional purposes.',
        'privacy.sms.usage': 'Usage:',
        'privacy.sms.usage_text': 'Your phone number is strictly used for the automation features you configure (e.g., missed call text back, lead nurturing, and appointment reminders).',
        'privacy.collect.title': 'Information We Collect',
        'privacy.collect.text': 'We collect information you provide directly to us, such as when you create an account, fill out a form, or communicate with us through our unified inbox. This includes:',
        'privacy.collect.li1': 'Contact Information (Name, Email, Phone Number)',
        'privacy.collect.li2': 'Business Details and Industry',
        'privacy.collect.li3': 'Communication History (SMS, Emails, AI Transcriptions)',
        'privacy.collect.li4': 'Billing Information (handled via secure payment processors)',
        'privacy.ai.title': 'AI Processing',
        'privacy.ai.text': 'True Pipeline utilizes advanced AI (including Google Gemini and Vapi) to automate your growth. Data processed by our AI is used strictly to enhance your business workflows and is never used to train external public models outside of your specific ecosystem\'s context.',
        'privacy.contact.title': 'Contact Us',
        'privacy.contact.text': 'If you have any questions about this Privacy Policy, please reach out to our privacy team at',

        // Terms of Service
        'terms.back': 'Back to Website',
        'terms.badge': 'Compliance',
        'terms.title': 'Terms of Service',
        'terms.updated': 'Last Updated: January 2025',
        'terms.1.title': '1. Agreement to Terms',
        'terms.1.text': 'By accessing or using True Pipeline, you agree to be bound by these Terms of Service. If you do not agree, you may not access our platform.',
        'terms.2.title': '2. Use of Automation & Messaging',
        'terms.2.intro': 'True Pipeline provides tools for automated SMS, Email, and Voice calling. You are solely responsible for:',
        'terms.2.li1': 'Complying with TCPA, GDPR, and other local regulations regarding automated outreach.',
        'terms.2.li2': 'Obtaining explicit opt-in consent from all leads before sending automated messages.',
        'terms.2.li3': 'Ensuring all AI-driven conversations represent your business accurately.',
        'terms.2.li4': 'Maintaining the proper opt-out (STOP) mechanisms for all telephony services.',
        'terms.3.title': '3. Subscriptions & Payments',
        'terms.3.text': 'We offer Starter, Growth, and Pro plans. By selecting a plan:',
        'terms.3.card1': 'You agree to recurring billing based on your selected cycle (Monthly/Annual).',
        'terms.3.card2': 'Cancellations must be processed before the next billing date.',
        'terms.4.title': '4. Prohibited Activities',
        'terms.4.text': 'You may not use True Pipeline to:',
        'terms.4.li1': 'Send unsolicited "spam" messages or illegal promotional content.',
        'terms.4.li2': 'Impersonate individuals or organizations without authorization.',
        'terms.4.li3': 'Reverse engineer the platform or AI logic.',
        'terms.4.li4': 'Circumvent security protocols or carrier filters (A2P 10DLC).',
        'terms.5.title': '5. Limitation of Liability',
        'terms.5.text': 'True Pipeline is provided "as is." We are not liable for any business interruptions, loss of leads, or regulatory fines resulting from your use or misuse of our automated communication tools.',
        'terms.contact': 'For any legal inquiries regarding these terms, please contact our legal department at',
    },
    es: {
        // Hero Words
        ...
        'privacy.badge': 'Privacidad Primero',
        'privacy.title': 'Política de Privacidad',
        'privacy.updated': 'Última actualización: Enero 2025',
        'privacy.commitment.title': 'Nuestro Compromiso',
        'privacy.commitment.text': 'En True Pipeline, nos tomamos muy en serio la privacidad de tus datos. Esta política describe cómo recopilamos, usamos y manejamos tu información cuando utilizas nuestro sitio web, CRM y herramientas de crecimiento automatizado.',
        'privacy.sms.title': 'Privacidad de SMS y Telefonía',
        'privacy.sms.intro': 'True Pipeline se basa en la comunicación multicanal. Tenemos reglas estrictas con respecto a los datos de números de teléfono:',
        'privacy.sms.consent': 'Consentimiento:',
        'privacy.sms.consent_text': 'Al proporcionar tu número de teléfono y aceptar a través de nuestros formularios, accedes a recibir mensajes SMS/MMS. Puedes responder STOP en cualquier momento para darte de baja.',
        'privacy.sms.sharing': 'No Compartir:',
        'privacy.sms.sharing_text': 'La información móvil NO se compartirá con terceros o afiliados para fines de marketing o promoción.',
        'privacy.sms.usage': 'Uso:',
        'privacy.sms.usage_text': 'Tu número de teléfono se utiliza estrictamente para las funciones de automatización que configures (p. ej., mensajes de llamada perdida, nutrición de leads y recordatorios de citas).',
        'privacy.collect.title': 'Información que Recopilamos',
        'privacy.collect.text': 'Recopilamos información que nos proporcionas directamente, como cuando creas una cuenta, completas un formulario o te comunicas con nosotros a través de nuestra bandeja de entrada unificada. Esto incluye:',
        'privacy.collect.li1': 'Información de contacto (Nombre, Email, Teléfono)',
        'privacy.collect.li2': 'Detalles del negocio e industria',
        'privacy.collect.li3': 'Historial de comunicación (SMS, Emails, Transcripciones de IA)',
        'privacy.collect.li4': 'Información de facturación (manejada a través de procesadores de pago seguros)',
        'privacy.ai.title': 'Procesamiento con IA',
        'privacy.ai.text': 'True Pipeline utiliza IA avanzada (incluyendo Google Gemini y Vapi) para automatizar tu crecimiento. Los datos procesados por nuestra IA se utilizan estrictamente para mejorar tus flujos de trabajo comerciales y nunca se utilizan para entrenar modelos públicos externos fuera del contexto de tu ecosistema específico.',
        'privacy.contact.title': 'Contáctanos',
        'privacy.contact.text': 'Si tienes alguna pregunta sobre esta Política de Privacidad, comunícate con nuestro equipo de privacidad en',

        // Terms of Service (Spanish)
        'terms.back': 'Volver al Sitio',
        'terms.badge': 'Cumplimiento',
        'terms.title': 'Términos de Servicio',
        'terms.updated': 'Última actualización: Enero 2025',
        'terms.1.title': '1. Acuerdo de Términos',
        'terms.1.text': 'Al acceder o utilizar True Pipeline, aceptas estar sujeto a estos Términos de Servicio. Si no estás de acuerdo, no puedes acceder a nuestra plataforma.',
        'terms.2.title': '2. Uso de Automatización y Mensajería',
        'terms.2.intro': 'True Pipeline proporciona herramientas para llamadas automatizadas de SMS, Email y Voz. Eres el único responsable de:',
        'terms.2.li1': 'Cumplir con TCPA, GDPR y otras regulaciones locales con respecto al alcance automatizado.',
        'terms.2.li2': 'Obtener el consentimiento explícito de todos los leads antes de enviar mensajes automatizados.',
        'terms.2.li3': 'Asegurar que todas las conversaciones impulsadas por IA representen a tu negocio con precisión.',
        'terms.2.li4': 'Mantener los mecanismos adecuados de baja (STOP) para todos los servicios de telefonía.',
        'terms.3.title': '3. Suscripciones y Pagos',
        'terms.3.text': 'Ofrecemos planes Starter, Growth y Pro. Al seleccionar un plan:',
        'terms.3.card1': 'Aceptas la facturación recurrente basada en tu ciclo seleccionado (Mensual/Anual).',
        'terms.3.card2': 'Las cancelaciones deben procesarse antes de la próxima fecha de facturación.',
        'terms.4.title': '4. Actividades Prohibidas',
        'terms.4.text': 'No puedes utilizar True Pipeline para:',
        'terms.4.li1': 'Enviar mensajes "spam" no solicitados o contenido promocional ilegal.',
        'terms.4.li2': 'Hacerte pasar por individuos u organizaciones sin autorización.',
        'terms.4.li3': 'Realizar ingeniería inversa de la plataforma o la lógica de IA.',
        'terms.4.li4': 'Eludir protocolos de seguridad o filtros de operadores (A2P 10DLC).',
        'terms.5.title': '5. Limitación de Responsabilidad',
        'terms.5.text': 'True Pipeline se proporciona "tal cual". No somos responsables de interrupciones comerciales, pérdida de leads o multas regulatorias resultantes de tu uso o mal uso de nuestras herramientas de comunicación automatizada.',
        'terms.contact': 'Para cualquier consulta legal con respecto a estos términos, comunícate con nuestro departamento legal en',
